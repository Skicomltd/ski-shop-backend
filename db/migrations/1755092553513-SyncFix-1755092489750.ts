...
export class SyncFix17550924897501755092553513 implements MigrationInterface {
    name = 'SyncFix17550924897501755092553513'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "voucher" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "status" "public"."voucher_status_enum" NOT NULL DEFAULT 'pending', "code" character varying NOT NULL, "dateWon" TIMESTAMP NOT NULL, "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, "prizeWon" integer NOT NULL, "prizeType" "public"."voucher_prizetype_enum" NOT NULL DEFAULT 'amount', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_677ae75f380e81c2f103a57ffaf" PRIMARY KEY ("id"))`);
