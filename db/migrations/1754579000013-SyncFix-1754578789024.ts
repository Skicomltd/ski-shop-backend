...
export class SyncFix17545787890241754579000013 implements MigrationInterface {
    name = 'SyncFix17545787890241754579000013'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" ADD "itemsCount" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "user" ADD "ordersCount" integer NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "ordersCount"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "itemsCount"`);
    }
