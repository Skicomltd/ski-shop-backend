...
export class SyncFix17539581492151753958154034 implements MigrationInterface {
    name = 'SyncFix17539581492151753958154034'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "withdrawal" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" numeric NOT NULL, "bankId" uuid NOT NULL, "status" "public"."withdrawal_status_enum" NOT NULL DEFAULT 'pending', "earningId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_840e247aaad3fbd4e18129122a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "earning" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "total" double precision NOT NULL DEFAULT '0', "available" double precision NOT NULL DEFAULT '0', "pending" double precision NOT NULL DEFAULT '0', "withdrawn" double precision NOT NULL DEFAULT '0', "storeId" character varying NOT NULL, CONSTRAINT "PK_f9c4d04c93fdab9eece8389a94e" PRIMARY KEY ("id"))`);
