...
export class SyncFix17642318120931764231817739 implements MigrationInterface {
    name = 'SyncFix17642318120931764231817739'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."order_status_enum" NOT NULL DEFAULT 'pending', "deliveryStatus" "public"."order_deliverystatus_enum" NOT NULL DEFAULT 'uninitiated', "deliveryAddress" text NOT NULL, "deliveryNo" text, "paymentMethod" "public"."order_paymentmethod_enum" NOT NULL, "reference" text NOT NULL DEFAULT '', "buyerId" uuid NOT NULL, "paidAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "password" character varying NOT NULL, "role" "public"."user_role_enum" NOT NULL DEFAULT 'customer', "email" character varying NOT NULL, "phoneNumber" text NOT NULL DEFAULT '', "address" text NOT NULL DEFAULT '', "profileImage" text NOT NULL DEFAULT '', "isEmailVerified" boolean NOT NULL DEFAULT false, "isPhoneNumberVerified" boolean NOT NULL DEFAULT false, "status" "public"."user_status_enum" NOT NULL DEFAULT 'inactive', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "itemsCount" integer NOT NULL DEFAULT '0', "ordersCount" integer NOT NULL DEFAULT '0', "fcmToken" text array NOT NULL DEFAULT '{}', CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "withdrawal" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" double precision NOT NULL, "currentWalletBalance" double precision NOT NULL, "bankId" uuid NOT NULL, "processedById" uuid, "status" "public"."withdrawal_status_enum" NOT NULL DEFAULT 'pending', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "dateApproved" TIMESTAMP, "payoutId" uuid, CONSTRAINT "PK_840e247aaad3fbd4e18129122a2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "pickup" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "contactPerson" character varying NOT NULL, "address" character varying NOT NULL, "state" character varying NOT NULL, "phoneNumber" character varying NOT NULL, "status" "public"."pickup_status_enum" NOT NULL DEFAULT 'active', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c432b21125ffd974cd0b1624f04" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "newsletter" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_036bb790d1d19efeacfd2f3740c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "withdrawal" ADD CONSTRAINT "FK_706704814617d1915dbd564c5b9" FOREIGN KEY ("processedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
