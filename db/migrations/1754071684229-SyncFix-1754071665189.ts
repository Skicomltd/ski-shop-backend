...
<<<<<<<< HEAD:db/migrations/1754194449541-SyncFix-1754194402424.ts
export class SyncFix17541944024241754194449541 implements MigrationInterface {
    name = 'SyncFix17541944024241754194449541'
...
>>>>>>>> 17f2de8cadd78041d0c123991dce90b699359c13:db/migrations/1754071684229-SyncFix-1754071665189.ts
...
<<<<<<<< HEAD:db/migrations/1754194449541-SyncFix-1754194402424.ts
        ...
        await queryRunner.query(`CREATE TABLE "withdrawal" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" double precision NOT NULL, "bankId" uuid NOT NULL, "status" "public"."withdrawal_status_enum" NOT NULL DEFAULT 'pending', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "payoutId" uuid, CONSTRAINT "PK_840e247aaad3fbd4e18129122a2" PRIMARY KEY ("id"))`);
