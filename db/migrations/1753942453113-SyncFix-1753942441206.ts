...
export class SyncFix17539424412061753942453113 implements MigrationInterface {
    name = 'SyncFix17539424412061753942453113'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."withdrawal_status_enum" AS ENUM('success', 'pending', 'failed')`);
        await queryRunner.query(`CREATE TABLE "withdrawal" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" numeric NOT NULL, "bankId" uuid NOT NULL, "status" "public"."withdrawal_status_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "earningId" uuid, CONSTRAINT "PK_840e247aaad3fbd4e18129122a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "earning" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "total" numeric NOT NULL DEFAULT '0', "available" numeric NOT NULL DEFAULT '0', "pending" numeric NOT NULL DEFAULT '0', "withdrawn" numeric NOT NULL DEFAULT '0', "storeId" character varying NOT NULL, CONSTRAINT "PK_f9c4d04c93fdab9eece8389a94e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."store_type_enum" AS ENUM('premium', 'skishop', 'basic')`);
        await queryRunner.query(`CREATE TABLE "store" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "logo" character varying NOT NULL, "isStarSeller" boolean NOT NULL DEFAULT false, "type" "public"."store_type_enum" NOT NULL DEFAULT 'basic', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "businessId" uuid, "earningId" uuid, CONSTRAINT "REL_bc7ec2c93335da88571ae84fbe" UNIQUE ("businessId"), CONSTRAINT "REL_8812aa858f1464d26c32778916" UNIQUE ("earningId"), CONSTRAINT "PK_f3172007d4de5ae8e7692759d79" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "plan" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "planCode" character varying NOT NULL, "interval" character varying NOT NULL, "name" character varying NOT NULL, "amount" integer NOT NULL, "savingPercentage" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_54a2b686aed3b637654bf7ddbb3" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "earning"`);
